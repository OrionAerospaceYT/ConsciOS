...
struct Orientation
{
	...
	void resolveOrientation(const T &gyro, T &accel, T &ypr, S &base, const F &dt)
	{
		...
		auto s1 = base_4.i * base_sq.k - base_2.k * norm_accel.x + 4.0f * base_sq.w * base.i - base_2.w * norm_accel.y - base_4.i + basei_8 * base_sq.i + basei_8 * base_sq.j + base_4.i * norm_accel.z;
		auto s2 = 4.0f * base_sq.w * base.j + base_2.w * norm_accel.x + base_4.j * base_sq.k - base_2.k * norm_accel.y - base_4.j + basej_8 * base_sq.i + basej_8 * base_sq.j + base_4.j * norm_accel.z;
